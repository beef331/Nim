...
function HEX2EHEX2E_520093730(a_520093733, b_520093734) {
  ...
  framePtr = F;
    F.line = 507;
    result_520093737 = nimCopy(result_520093737, {a: a_520093733, b: b_520093734}, NTI520093730);
  framePtr = F.prev;
...
function HEX3DHEX3D_520093708(x_520093710, y_520093711) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      F.line = 308;
      colontmp__520093956 = nimCopy(colontmp__520093956, HEX2EHEX2E_520093730(0, subInt((x_520093710).length, 1)), NTI520093730);
      Label2: do {
        F.line = 129;
        var x_520093962 = 0;
        F.line = 90;
...
function HEX3DHEX3D_520093799(x_520093801, y_520093802) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      F.line = 308;
      colontmp__520093966 = nimCopy(colontmp__520093966, HEX2EHEX2E_520093730(0, subInt((x_520093801).length, 1)), NTI520093730);
      Label2: do {
        F.line = 129;
        var x_520093968 = 0;
        F.line = 90;
...
Label1: do {
  ...
  F.line = 11;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(11, 10) `header.hasKey(\"key\")` "));
  }
  
  if (!(HEX3DHEX3D_520093708(Array.from(header_520093698.keys()), ["key"]))) {
  F.line = 12;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(12, 10) `header.keys() == @[\"key\".cstring]` "));
  }
  
  if (!(HEX3DHEX3D_520093708(Array.from(header_520093698.values()), ["value"]))) {
  F.line = 13;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(13, 10) `header.values() == @[\"value\".cstring]` "));
  }
  
  if (!((header_520093698.get("key") == "value"))) {
  F.line = 14;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(14, 10) `header[\"key\"] == \"value\".cstring` "));
  }
  ...
  F.line = 16;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(16, 10) `header[\"other\"] == \"another\".cstring` "));
  }
  
  if (!(HEX3DHEX3D_520093799(Array.from(header_520093698.entries()), [{Field0: "key", Field1: "value"}, {Field0: "other", Field1: "another"}]))) {
  F.line = 17;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(17, 10) `header.entries() ==\x0A    @[(\"key\".cstring, \"value\".cstring), (\"other\".cstring, \"another\".cstring)]` "));
  }
  
  if (!((JSON.stringify(Array.from(header_520093698.entries())) == "[[\"key\",\"value\"],[\"other\",\"another\"]]"))) {
  F.line = 18;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(18, 10) `header.toCstring() == \"\"\"[[\"key\",\"value\"],[\"other\",\"another\"]]\"\"\".cstring` "));
  }
  ...
  F.line = 20;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(20, 10) `header.entries() == @[(\"key\".cstring, \"value\".cstring)]` "));
  }
  ...
  F.line = 22;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(22, 10) `header.entries() == @[]` "));
  }
  
  if (!((Array.from(header_520093698.entries()).length == 0))) {
  F.line = 23;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(23, 10) `header.len == 0` "));
  }
...
Label2: do {
  ...
  F.line = 30;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(30, 10) `header[\"key\"] == \"a, b, c\".cstring` "));
  }
  ...
  F.line = 32;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(32, 10) `header[\"key\"] == \"value\".cstring` "));
  }
...
Label3: do {
  ...
  F.line = 38;
  failedAssertImpl_218103866(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples1.nim(38, 10) `header[\"key\"] == \"b\".cstring` "));
  }
